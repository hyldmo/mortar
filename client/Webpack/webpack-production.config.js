...
var rootAssetPath = path.join(__dirname, 'assets/');
var rootSrcPath = path.join(__dirname, 'src/');
var out = '../PyServer/static/scripts';
var CONFIG = require('./config/production');

module.exports = {
    entry: {
        recipes: [
            path.resolve(rootSrcPath, 'recipes/entry.jsx')
        ],
        addrecipe: [
            path.resolve(rootSrcPath, 'addrecipe/entry.jsx')
        ]
    },
    output: {
